...
// 银行
export const findBanks = params => { return axios.get(`/v1/admin_api/bank/query`, { params: params }).then(res => res.data) }
export const saveBank = params => { return axios.post(`/v1/admin_api/bank/save`, params).then(res => res.data) }
export const deleteBank = params => { return axios.post(`/v1/admin_api/bank/delete`, params).then(res => res.data) }

// 服务商
export const findServiceProviders = params => { return axios.get(`/v1/admin_api/service_provider/query`, { params: params }).then(res => res.data) }
export const saveServiceProvider = params => { return axios.post(`/v1/admin_api/service_provider/save`, params).then(res => res.data) }
export const deleteServiceProvider = params => { return axios.post(`/v1/admin_api/service_provider/delete`, params).then(res => res.data) }